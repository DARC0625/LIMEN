...
#### 4. 백엔드 로그 확인
```bash
tail -f /home/darc0/LIMEN/backend/server.log | grep -E "(vnc|VNC|websocket)"
```
...
```bash
grep ALLOWED_ORIGINS /home/darc0/LIMEN/backend/.env
```
...
```bash
# 실시간 로그 확인
tail -f /home/darc0/LIMEN/backend/server.log

# 특정 오류 검색
grep -i "error\|fatal\|panic" /home/darc0/LIMEN/backend/server.log | tail -20
```
...
- [백엔드 API 문서](../../RAG/API_DOCUMENTATION.md)
