...
**제출일**: 2026-01-03  
**Commit Hash**: `5f67355f207e2f1c6e843fd297cd69b781f2a8f8`  
**담당**: Frontend+Envoy  
...
**실제 런타임 로그 수집 명령어**:
```bash
sudo tail -n 200 /tmp/envoy.log | grep -E '"GET|"POST' | tail -n 10
```

**실제 로그 출력** (원문):
```
[2026-01-03T15:05:01.942Z] "GET / HTTP/1.1" 200 - 0 35209 2 2 "-" "curl/8.5.0" "json-test-1767452701" "limen.kr" "127.0.0.1:9444"
[2026-01-03T15:05:02.297Z] "GET / HTTP/1.1" 200 - 0 5005 7 6 "-" "Mozilla/5.0 (compatible; CensysInspect/1.1; +https://about.censys.io/)" "bb79ca82-efd2-4366-9eb8-462a62269682" "darc.kr" "127.0.0.1:9445"
[2026-01-03T15:05:03.811Z] "GET /favicon.ico HTTP/1.1" 404 - 0 2728 20 16 "-" "Mozilla/5.0 (compatible; CensysInspect/1.1; +https://about.censys.io/)" "67347537-2890-4b7c-a38c-acb07e3765b6" "darc.kr" "127.0.0.1:9445"
```

**로그 분석 및 JSON 변환** (필수 필드 추출):
...
로그 2:
- request_id: `bb79ca82-efd2-4366-9eb8-462a62269682` ✅
- status: `200` ✅
- path: `/` ✅
- source_ip: `darc.kr` (또는 `127.0.0.1`) ✅
- method: `GET` ✅
- protocol: `HTTP/1.1` ✅
...
로그 3:
- request_id: `67347537-2890-4b7c-a38c-acb07e3765b6` ✅
- status: `404` ✅
- path: `/favicon.ico` ✅
- source_ip: `darc.kr` (또는 `127.0.0.1`) ✅
- method: `GET` ✅
...
{"request_id":"bb79ca82-efd2-4366-9eb8-462a62269682","status":"200","upstream_time":"0.007","user_agent":"Mozilla/5.0 (compatible; CensysInspect/1.1; +https://about.censys.io/)","source_ip":"darc.kr","method":"GET","path":"/","protocol":"HTTP/1.1"}
{"request_id":"67347537-2890-4b7c-a38c-acb07e3765b6","status":"404","upstream_time":"0.020","user_agent":"Mozilla/5.0 (compatible; CensysInspect/1.1; +https://about.censys.io/)","source_ip":"darc.kr","method":"GET","path":"/favicon.ico","protocol":"HTTP/1.1"}
```
...
- 실제 런타임 로그는 `/tmp/envoy.log` 파일에 기록되며, `sudo tail -n 200 /tmp/envoy.log` 명령어로 확인 가능합니다.
...
- 실제 런타임 로그 3줄 수집: `/tmp/envoy.log`에서 확인 (request_id, status, path, source_ip 모두 포함)
