...
- **실행 파일**: `/home/darc0/projects/LIMEN/backend/agent/target/release/agent`
- **로그 파일**: `/home/darc0/projects/LIMEN/backend/agent/agent.log`
...
```bash
# 서비스 파일 복사
sudo cp /home/darc0/projects/LIMEN/scripts/limen.service /etc/systemd/system/
...
```bash
# 실시간 로그 확인
tail -f /home/darc0/projects/LIMEN/backend/agent/agent.log

# 최근 로그 확인
tail -50 /home/darc0/projects/LIMEN/backend/agent/agent.log
```
...
2. **백엔드 로그 확인**
   ```bash
   tail -50 /home/darc0/projects/LIMEN/backend/server.log | grep agent
   ```
...
`/home/darc0/projects/LIMEN/scripts/limen.service` 파일이 백엔드와 Agent를 함께 관리합니다:
